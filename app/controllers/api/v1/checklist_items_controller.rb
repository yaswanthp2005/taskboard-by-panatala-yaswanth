...
class Api::V1::ChecklistItemsController < ApplicationController
  ...
  def create
    ...
    checklist_item.save!
    render_notice(t("successfully_created", entity: t("entities.checklist_item")), :ok)
  end
  ...
  def bulk_delete
    ...
    render_notice(t("successfully_deleted", count: deleted_count, entity: t("entities.checklist_item")))
  end

  def update
    authorize @checklist_item
    @checklist_item.update!(checklist_item_params)
    render_notice(t("successfully_updated", entity: t("entities.checklist_item")), :ok)
  end

  def destroy
    authorize @checklist_item
    @checklist_item.destroy!
    render_notice(t("successfully_deleted", count: 1, entity: t("entities.checklist_item")))
  end
